        ...
        <div className="relative overflow-hidden border border-border bg-card">
          ...
          <div className="grid md:grid-cols-5 gap-0">
            ...
            <div className="md:col-span-3 p-8 md:p-12 lg:p-16 flex flex-col justify-center">
              ...
              <h2 className="font-display text-2xl md:text-3xl lg:text-4xl font-light text-foreground leading-tight mb-4">
                {t({
                  th: "ประเมินหลุมสิวของคุณ\nใน 1 นาที",
                  en: "Assess Your Acne Scars\nin 1 Minute",
                })}
              </h2>
              <p className="font-body text-sm font-light text-muted-foreground leading-relaxed max-w-md mb-8">
                {t({
              ...
              <button
                ...
                className="group inline-flex items-center gap-3 font-body text-xs tracking-widest uppercase bg-primary text-primary-foreground px-8 py-4 hover:bg-primary/90 transition-all duration-300 self-start"
              >
            ...
            {/* Right visual */}
            <div className="md:col-span-2 bg-gradient-to-br from-primary/5 via-primary/10 to-primary/5 p-8 md:p-12 flex flex-col items-center justify-center text-center border-t md:border-t-0 md:border-l border-border">
              <div className="space-y-6">
                ...
                {[
                  ...
                  <div key={i} className="flex items-center gap-4">
                    <div className="w-8 h-8 rounded-full border border-primary/30 flex items-center justify-center text-primary font-body text-xs font-medium shrink-0">
                      {i + 1}
                    </div>
                    <p className="font-body text-sm font-light text-foreground/70 text-left">
                      {t(step)}
                    </p>
                  </div>
                ))}
