...
- The top of the doctor's HEAD starts at 20% from the top edge of the image.
- The doctor's body extends all the way down to the BOTTOM edge of the image.
- The doctor should occupy approximately 80% of the image height (from 20% to 100%).
- Show from head to approximately waist or hips, filling the right portion vertically.
